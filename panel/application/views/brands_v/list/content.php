<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">Marka Listesi <a type="button" href="<?=base_url("brands/new_form");?>" class="btn btn-xs btn-primary pull-right btn-outline"><i class="fa fa-plus-square"></i> Ekle</a></h4>
        ...
        <div class="widget p-lg">
            ...
            {?>
                <div class="alert alert-info text-center">
                    <p>Aradığınız ürün bulunamamaktadır. Eklemek için lütfen <a href="<?=base_url("brands/new_form");?>">tıklayınız</a></p>
                </div>
            <?php }
            else{ ?>
                ...
                foreach ($items as $item)
                    {?>
                            ...
                            <td>
                                ...
                                <a type="button" href="<?=base_url("brands/update_form/$item->id");?>" class="btn btn-xs btn-info btn-outline update-btn">
